...
const char *LIBNSOCKET_MODULENAME = "libnsocket";
...
NMemoryAllocators __libnsocket_allocators = {0};
NPanicHandler *__libnsocket_panichandler = NULL;
NAlertHandler *__libnsocket_alerthandler = NULL;
NUnorderedSet *__libnsocket_sockslist = NULL;
NThreadMutex *__libnsocket_sockslistmutex = NULL;
...
void __libnsocket_defaultpanichandler(const char *module, const char *file, long long line, const char *function, const char *description, NError error)
{
    fprintf(stderr, "\n\n\n###################\n# LIBNSOCKET PANIC #\n###################\n\n");
...
void __libnsocket_defaultalerthandler(const char *module, const char *file, long long line, const char *function, const char *format, ...)
{
    va_list args;
